...
// NOTE: these are original illustrated graphics generated for this demo,
// not real photographs of an actual cafe. Swap each path below for a real
// photo (same filename works) once photography is available.
const GALLERY_ITEMS = [
  { category: "Our Cafe", path: "assets/images/cafe/storefront.svg" },
  { category: "Our Cafe", path: "assets/images/cafe/interior-seating.svg" },
  { category: "Our Cafe", path: "assets/images/cafe/counter.svg" },
  { category: "Food", path: "assets/images/food/pizza-spread.svg" },
  { category: "Food", path: "assets/images/food/burger-plate.svg" },
  { category: "Food", path: "assets/images/food/pasta-bowl.svg" },
  { category: "Coffee & Drinks", path: "assets/images/coffee/latte-art.svg" },
  { category: "Coffee & Drinks", path: "assets/images/coffee/cold-coffee-glass.svg" },
  { category: "Coffee & Drinks", path: "assets/images/coffee/mojito-cooler.svg" },
  { category: "Desserts", path: "assets/images/desserts/cheesecake-slice.svg" },
  { category: "Desserts", path: "assets/images/desserts/brownie-plate.svg" },
  { category: "Ambience", path: "assets/images/cafe/evening-ambience.svg" }
];
...
function itemCardHTML(item){
  ...
  const img = CATEGORY_IMAGES[item.category] || "";
  return `
    <article class="item-card" data-id="${item.id}">
      <div class="item-media">
        ${tag}
        <img src="${img}" alt="${escapeHTML(item.name)} — illustrative graphic, replace with a real photo" loading="lazy">
      </div>
      <div class="item-body">
        <div class="item-top">
...
function renderGallery(){
  ...
  grid.innerHTML = items.map(i => `
    <div class="gallery-tile" tabindex="0">
      <img src="${escapeHTML(i.path)}" alt="${escapeHTML(i.category)} — illustrative graphic, replace with a real photo" loading="lazy">
    </div>
  `).join("");
}
